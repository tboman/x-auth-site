...
func (h *LoginHandlers) page(w http.ResponseWriter, status int, title, body string, brand Branding) {
...
.btn{appearance:none;width:100%;border:0;border-radius:8px;background:var(--accent);color:var(--on-accent);font-weight:800;padding:12px 14px;text-decoration:none;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;font:inherit;font-weight:800}
